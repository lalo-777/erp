...
--
-- Table structure for table `warehouse_reorganization`
--

DROP TABLE IF EXISTS `warehouse_reorganization`;
...
CREATE TABLE `warehouse_reorganization` (
  ...
  KEY `idx_date` (`reorganization_date`),
  KEY `fk_reorg_from` (`from_location_id`),
  KEY `fk_reorg_to` (`to_location_id`),
  KEY `fk_reorg_performed_by` (`performed_by`),
...
--
-- Dumping data for table `warehouse_reorganization`
--

LOCK TABLES `warehouse_reorganization` WRITE;
/*!40000 ALTER TABLE `warehouse_reorganization` DISABLE KEYS */;
/*!40000 ALTER TABLE `warehouse_reorganization` ENABLE KEYS */;
UNLOCK TABLES;
