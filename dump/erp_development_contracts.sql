...
CREATE TABLE `contracts` (
  ...
  KEY `idx_status` (`contract_status_id`),
  KEY `fk_contracts_type` (`contract_type_id`),
  KEY `fk_contracts_created_by` (`created_by`),
  KEY `fk_contracts_modified_by` (`modified_by`),
  KEY `fk_contracts_file` (`contract_file_id`),
  ...
  CONSTRAINT `fk_contracts_file` FOREIGN KEY (`contract_file_id`) REFERENCES `files` (`id`) ON DELETE SET NULL,
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_contracts_audit` BEFORE UPDATE ON `contracts` FOR EACH ROW BEGIN
